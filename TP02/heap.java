...
public class heap {
    ...
    public static void heapMax(Personagens[] personagens, int n, int i){
        ...
        if (esq < n && 
        (personagens[esq].hairColour.compareTo(personagens[maior].hairColour) > 0 ||
         (personagens[esq].hairColour.equals(personagens[maior].hairColour) &&
          personagens[esq].name.compareTo(personagens[maior].name) > 0))) {
        maior = esq;
    }

    if (dir < n &&
        (personagens[dir].hairColour.compareTo(personagens[maior].hairColour) > 0 ||
         (personagens[dir].hairColour.equals(personagens[maior].hairColour) &&
          personagens[dir].name.compareTo(personagens[maior].name) > 0))) {
        maior = dir;
    }
    ...
    public static void ordenando(){
        Personagens tmp = new Personagens();
        int n = totalPersonagens;

        for(int i=n/2-1; i >= 0; i--){
            heapMax(personagens, n, i);
        }
